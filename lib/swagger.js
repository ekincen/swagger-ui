...
(function() {
    ...
    SwaggerResource.prototype.addOperations = function(resource_path, ops) {
      ...
      if (ops) {
        ...
        for (_i = 0, _len = ops.length; _i < _len; _i++) {
          o = ops[_i]; 
          op = new SwaggerOperation(o.nickname, resource_path, o.httpMethod, o.parameters, o.summary, o.notes, this,o.description,o.updateTime,o.reviser,o.revisionDesc,o.revisionHighlight);
  ...
  SwaggerOperation = (function() {
    ...
    function SwaggerOperation(nickname, path, httpMethod, parameters, summary, notes, resource,description,updateTime,reviser,revisionDesc,revisionHighlight) {
      ...
      this.revisionHighlight=revisionHighlight;
